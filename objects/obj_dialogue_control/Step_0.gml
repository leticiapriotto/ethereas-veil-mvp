...
for (var _i = 0; _i < option_count; _i++) {
    ...
    if (ChatterboxGetOptionConditionBool(chatterbox, _i)) {
        ...
        var _sprite_list = get_sprite_list(node_title); // Call the new method to get the sprite list
        var _sprite_width = sprite_get_width(_sprite_list[_i]);
        var _sprite_height = sprite_get_height(_sprite_list[_i]);
